...
metadata:
    github-path: .agents/skills/mino-reproducible-development
    github-ref: refs/tags/0.9.0
    github-repo: https://github.com/my-take-dev/inspired-mino-design-skills
    github-tree-sha: 4b034429c32f308850ea81fe38eb1f9a2ad7eb1d
...
- filesystem、process、shell、toolchain、test実行、複数platform対応を扱うときだけ`skills/mino-core/references/platform-compatibility.md`を読む。
...
- Windows、Linux、macOSのうち複数がrequiredなら、各platformの実行結果を独立Evidenceとして保持する。
- 一部を実行できない場合は`unexecuted_validation`と`platform_validation.parity_result: incomplete`を返し、required platform全体をverifiedとしない。
